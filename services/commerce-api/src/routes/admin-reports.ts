import { GstReport, GstReportQuery, ProductReport, ProductReportQuery, SalesReport, SalesReportQuery } from "@kleawip/contract";
import type { FastifyPluginAsync } from "fastify";
import { authorize } from "../auth/guard";
import type { Database } from "../db/client";
import { gstCsv, gstReport, productReport, salesReport } from "../reports/service";
