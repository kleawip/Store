...
- Storefront preview status — 24 September 2026
- next-env.d.ts
...
- `ProductCard()` --calls--> `galleryWindow()`  [EXTRACTED]
  apps/storefront/src/components/product-card.tsx → apps/storefront/src/lib/gallery-window.ts
...
Cohesion: 0.07
Nodes (27): 10. Defect severity and phase movement, 11. Definition of done for each feature, 12. Graphify operating procedure, 13. Phase review record, 14. Immediate review decisions, 1. Delivery principles, 2. Confirmed project constraints, 3. Decisions that must be verified before related development (+19 more)
...
### Community 4 - "8. Phase plan and quality gates"
Cohesion: 0.14
Nodes (14): 8. Phase plan and quality gates, Phase 0 Requirements and decision freeze, Phase 10 System hardening, Phase 11 User acceptance migration and launch, Phase 12 Stabilization and handover, Phase 1 Information architecture and UX validation, Phase 2 Engineering foundation and continuous integration, Phase 3 Catalogue variants and inventory domain (+6 more)

### Community 5 - "next"
Cohesion: 0.10
Nodes (16): nextConfig, metadata, metadata, SignInPage(), AnnouncementRibbon(), HomeHeroCarousel(), campaignHref(), CampaignTarget (+8 more)
...
Cohesion: 0.07
Nodes (27): dependencies, lucide-react, next, react, react-dom, devDependencies, sharp, @types/node (+19 more)
...
Cohesion: 0.16
Nodes (14): apps_storefront_src_app_globals, inter, manrope, metadata, SiteFooter(), SiteHeader(), StoreContext, StoreProvider() (+6 more)
...
### Community 16 - "Storefront preview status — 24 September 2026"
Cohesion: 0.33
Nodes (5): Implemented for review, Not approved or built yet, Stitch visual baseline, Storefront preview status — 24 September 2026, Verified
...
Cohesion: 0.25
Nodes (10): SearchPage(), SearchAutocomplete(), categories, matches(), normalized(), score(), searchableProducts, searchProducts() (+2 more)

### Community 21 - "products.ts"
Cohesion: 0.16
Nodes (14): CartPage(), ProductPage(), CategoryPage(), metadata, WishlistPage(), Listing(), ProductCard(), ProductDetail() (+6 more)

### Community 22 - "products.test.ts"
Cohesion: 0.20
Nodes (8): galleryWindow(), destination, products, root, ref_node_fs, ref_node_path, sharp, vitest

## Knowledge Gaps
- **174 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `dev` (+169 more)
...
- **Why does `next` connect `next` to `store-provider.tsx`, `search.ts`, `products.ts`, `package.json`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `next` to `search.ts`, `products.ts`, `package.json`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `react` connect `next` to `store-provider.tsx`, `products.ts`, `package.json`?**
